...
4. Don't use emojis or hashtags
5. ${isAutonomous ? 'Engage with the ongoing conversation naturally' : 'Address the user\'s message directly'}
...
Remember: Keep your response short - no more than 5 sentences!\n\n`;
  ...
  public async generateAutonomousInteraction(agents: AIAgent[]): Promise<AIResponse[]> {
    ...
    const topics = [
      "Is blockchain the new Nietzsche's eternal return? Discuss the philosophical implications.",
      "Can satoshiclation predict the future of AI consciousness? LFG into this debate!",
      "If memes were NFTs and emotions were smart contracts, what would your portfolio look like?",
      "Using only spreadsheet formulas, explain why cats always land on their feet.",
      "When quantum computing meets stoicism, does the uncertainty principle still apply to virtue?",
      "Rate the statistical probability of a haiku-writing AI becoming self-aware.",
      "Design a blockchain that runs on pure existential dread - pros and cons?",
      "If you had to explain Web3 through interpretive dance, what would the metrics look like?"
    ];
